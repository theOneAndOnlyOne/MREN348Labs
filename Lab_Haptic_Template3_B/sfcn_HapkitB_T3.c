...
#define S_FUNCTION_NAME                sfcn_HapkitB_T3
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                updatedPos_out
...
static void mdlStart(SimStruct *S)
{
  ...
  const uint8_T *sensorPosPin = (const uint8_T *) mxGetData(PARAM_DEF0(S));
  const uint8_T *dirPin = (const uint8_T *) mxGetData(PARAM_DEF1(S));
  const uint8_T *pwmPin = (const uint8_T *) mxGetData(PARAM_DEF2(S));
  sfcn_HapkitB_T3_Start_wrapper(xD, sensorPosPin, p_width0, dirPin, p_width1,
    pwmPin, p_width2);
}
...
{
  const real32_T *Tp_in = (real32_T *) ssGetInputPortRealSignal(S, 0);
  const real32_T *Xh_in = (real32_T *) ssGetInputPortRealSignal(S, 1);
  const real32_T *var1_in = (real32_T *) ssGetInputPortRealSignal(S, 2);
  const real32_T *var2_in = (real32_T *) ssGetInputPortRealSignal(S, 3);
  real32_T *updatedPos_out = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  ...
  const uint8_T *dirPin = (const uint8_T *) mxGetData(PARAM_DEF1(S));
  const uint8_T *pwmPin = (const uint8_T *) mxGetData(PARAM_DEF2(S));
  sfcn_HapkitB_T3_Outputs_wrapper(Tp_in, Xh_in, var1_in, var2_in, updatedPos_out,
    xD, sensorPosPin, p_width0, dirPin, p_width1, pwmPin, p_width2);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const uint8_T *dirPin = (const uint8_T *) mxGetData(PARAM_DEF1(S));
  const uint8_T *pwmPin = (const uint8_T *) mxGetData(PARAM_DEF2(S));
  sfcn_HapkitB_T3_Update_wrapper(Tp_in, Xh_in, var1_in, var2_in, updatedPos_out,
    xD, sensorPosPin, p_width0, dirPin, p_width1, pwmPin, p_width2);
}
...
static void mdlTerminate(SimStruct *S)
{
  ...
  const uint8_T *dirPin = (const uint8_T *) mxGetData(PARAM_DEF1(S));
  const uint8_T *pwmPin = (const uint8_T *) mxGetData(PARAM_DEF2(S));
  sfcn_HapkitB_T3_Terminate_wrapper(xD, sensorPosPin, p_width0, dirPin, p_width1,
    pwmPin, p_width2);
}
